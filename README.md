...
Full package list:
    ...
    doctrine/inflector                 2.0.4    PHP Doctrine Inflector is a small library that can perform string mani...
    doctrine/instantiator              1.4.0    A small, lightweight utility to instantiate objects in PHP without inv...
    doctrine/lexer                     1.2.1    PHP Doctrine Lexer parser library that can be used in Top-Down, Recurs...
    dragonmantank/cron-expression      v3.1.0   CRON for PHP: Calculate the next or previous run date and determine if...
    ...
    fruitcake/laravel-cors             v2.0.4   Adds CORS (Cross-Origin Resource Sharing) headers support in your Lara...
    ...
    jaybizzle/crawler-detect           v1.2.108 CrawlerDetect is a PHP class for detecting bots/crawlers/spiders via t...
    jenssegers/agent                   v2.6.4   Desktop/mobile user agent parser with support for Laravel, based on Mo...
    laravel/fortify                    v1.8.3   Backend controllers and scaffolding for Laravel authentication.
    laravel/framework                  v8.69.0  The Laravel Framework.
    laravel/jetstream                  v2.4.4   Tailwind scaffolding for the Laravel framework.
    laravel/sail                       v1.12.2  Docker files for running a basic Laravel application.
    laravel/sanctum                    v2.12.1  Laravel Sanctum provides a featherweight authentication system for SPA...
    laravel/serializable-closure       v1.0.3   Laravel Serializable Closure provides an easy and secure way to serial...
    laravel/tinker                     v2.6.2   Powerful REPL for the Laravel framework.
    league/commonmark                  2.0.2    Highly-extensible PHP Markdown parser which fully supports the CommonM...
    league/config                      v1.1.1   Define configuration arrays with strict schemas and access values with...
    ...
    livewire/livewire                  v2.7.2   A front-end framework for Laravel.
    mobiledetect/mobiledetectlib       2.8.37   Mobile_Detect is a lightweight PHP class for detecting mobile devices....
    mockery/mockery                    1.4.4    Mockery is a simple yet flexible PHP mock object framework
    monolog/monolog                    2.3.5    Sends your logs to files, sockets, inboxes, databases and various web ...
    ...
    nette/utils                        v3.2.5   �  Nette Utils: lightweight utilities for string & arra y manipulati...
    ...
    opis/closure                       3.6.2    A library that can be used to serialize closures (anonymous functions)...
    paragonie/constant_time_encoding   v2.4.0   Constant-time Implementations of RFC 4648 Encoding (Base-64, Base-32, ...
    phar-io/manifest                   2.0.3    Component for reading phar.io manifest information from a PHP Archive ...
    phar-io/version                    3.1.0    Library for handling version information and constraints
    phpdocumentor/reflection-common    2.2.0    Common reflection classes used by phpdocumentor to reflect the code st...
    ...
    phpunit/php-code-coverage          9.2.8    Library that provides collection, processing, and rendering functional...
    phpunit/php-file-iterator          3.0.5    FilterIterator implementation that filters files based on a list of su...
    phpunit/php-invoker                3.1.1    Invoke callables with a timeout
    phpunit/php-text-template          2.0.4    Simple template engine.
    phpunit/php-timer                  5.0.3    Utility class for timing
    phpunit/phpunit                    9.5.10   The PHP Unit Testing framework.
    pragmarx/google2fa                 8.0.0    A One Time Password Authentication package, compatible with Google Aut...
    ...
    ramsey/uuid                        4.2.3    A PHP library for generating and working with universally unique ident...
    ...
    sebastian/object-enumerator        4.0.4    Traverses array structures and object graphs to enumerate all referenc...
    sebastian/object-reflector         2.0.4    Allows reflection of object attributes, including inherited and non-pu...
    sebastian/recursion-context        4.0.4    Provides functionality to recursively process PHP variables
    sebastian/resource-operations      3.0.3    Provides a list of PHP built-in functions that operate on resources
    sebastian/type                     2.3.4    Collection of value objects that represent the types of the PHP type s...
    sebastian/version                  3.0.2    Library that helps with managing the version number of Git-hosted PHP ...
    ...
    symfony/event-dispatcher           v5.3.7   Provides tools that allow your application components to communicate w...
    ...
    symfony/string                     v5.3.10  Provides an object-oriented API to strings and deals with bytes, UTF-8...
    ...
    theseer/tokenizer                  1.2.1    A small library for converting tokenized PHP source code into XML and ...
    tijsverkoyen/css-to-inline-styles  2.2.3    CssToInlineStyles is a class that enables you to convert HTML-pages/fi...
    vlucas/phpdotenv                   v5.3.1   Loads environment variables from `.env` to `getenv()`, `$_ENV` and `$_...
    voku/portable-ascii                1.5.6    Portable ASCII library - performance optimized (ascii) string function...
